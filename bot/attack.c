...
//Return the str if the key is right
...
{
	//Got the val if the opt in opts
    ...
    if (val == NULL)
		...
		//we need the char value to int type
...
{
	//Using the attack vector and attack func to create a method
